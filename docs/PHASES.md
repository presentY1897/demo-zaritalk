...
**Phase 완료 조건**
- [x] 전 task ✅ (원장 엔진 단위 테스트 6개 축 포함)
- [x] E2E: 계약 등록 / 연체 수납 / 고지서→가입→수락 그로스 여정 green (전체 18 spec)
- [x] 라이브 시연: 임대인 로그인 → 수납 현황 → 고지서 발송 → 공개 페이지

**Phase 1 완료 (2026-09-02).** 단위·API 437 · E2E 18 green.
